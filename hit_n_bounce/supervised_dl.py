"""
Détection supervisée des événements tennis avec Deep Learning.
Utilise un réseau de neurones (LSTM + Dense) pour classifier hit/bounce/air.
"""
...
# -------------------------------------------------------------------------
# Feature Engineering - Identique au supervised.py
# -------------------------------------------------------------------------
